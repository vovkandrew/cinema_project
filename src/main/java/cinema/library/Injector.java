...
public class Injector {
    ...
    public static cinema.library.Injector getInstance(String mainPackageName) {
        if (injectors.containsKey(mainPackageName)) {
            return injectors.get(mainPackageName);
        }
        cinema.library.Injector injector = new cinema.library.Injector(mainPackageName);
    ...
    public Object getInstance(Class<?> certainInterface) {
        ...
        for (Field field : declaredFields) {
            ...
            if (field.getDeclaredAnnotation(cinema.library.Inject.class) != null) {
